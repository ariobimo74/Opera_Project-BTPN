...
public class SampleLocalServiceWrapper
	 ...
	 */
	@Override
	public operation.model.Sample addSample(operation.model.Sample sample) {
	 ...
	 */
	@Override
	public operation.model.Sample createSample(long sampleId) {
	 ...
	 */
	@Override
	public operation.model.Sample deleteSample(long sampleId)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	@Override
	public operation.model.Sample deleteSample(operation.model.Sample sample) {
	...
	@Override
	public operation.model.Sample fetchSample(long sampleId) {
	 ...
	 */
	@Override
	public operation.model.Sample getSample(long sampleId)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	@Override
	public java.util.List<operation.model.Sample> getSamples(
		int start, int end) {
	 ...
	 */
	@Override
	public operation.model.Sample updateSample(operation.model.Sample sample) {
