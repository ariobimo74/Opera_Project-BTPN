...
public class AnswerUtil {
	 ...
	 */
	public static Answer create(long id) {
	 ...
	 */
	public static Answer remove(long id)
		throws operation.exception.NoSuchAnswerException {
	 ...
	 * @throws NoSuchAnswerException if a answer with the primary key could not be found
	 */
	public static Answer findByPrimaryKey(long id)
		throws operation.exception.NoSuchAnswerException {
	 ...
	 */
	public static Answer fetchByPrimaryKey(long id) {
