 ...
 * <code>operation.service.impl.SurveyObjectLocalServiceImpl</code> and
...
public class SurveyObjectLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>operation.service.impl.SurveyObjectLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static operation.model.SurveyObject addSurveyObject(
	 ...
	 */
	public static operation.model.SurveyObject createSurveyObject(long id) {
	 ...
	 */
	public static operation.model.SurveyObject deleteSurveyObject(long id)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 * @return the survey object that was removed
	 */
	public static operation.model.SurveyObject deleteSurveyObject(
		operation.model.SurveyObject surveyObject) {
	...
	public static operation.model.SurveyObject fetchSurveyObject(long id) {
	...
	public static java.util.List<operation.model.SurveyObject>
		getAllSurveyObjext() {

		return getService().getAllSurveyObjext();
	}
	 ...
	 * @throws PortalException if a survey object with the primary key could not be found
	 */
	public static operation.model.SurveyObject getSurveyObject(long id)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	public static java.util.List<operation.model.SurveyObject> getSurveyObjects(
		int start, int end) {
	 ...
	 */
	public static operation.model.SurveyObject updateSurveyObject(
		operation.model.SurveyObject surveyObject) {
