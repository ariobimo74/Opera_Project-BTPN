...
/**
 * Provides the local service interface for SurveyObject. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see SurveyObjectLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface SurveyObjectLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link SurveyObjectLocalServiceUtil} to access the survey object local service. Add custom service methods to <code>operation.service.impl.SurveyObjectLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	public SurveyObject addSurveyObject(SurveyObject surveyObject);
	...
	public SurveyObject createSurveyObject(long id);
	...
	public SurveyObject deleteSurveyObject(long id) throws PortalException;
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public SurveyObject deleteSurveyObject(SurveyObject surveyObject);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public SurveyObject fetchSurveyObject(long id);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ActionableDynamicQuery getActionableDynamicQuery();

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<SurveyObject> getAllSurveyObjext();
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<SurveyObject> getSurveyObjects(int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public SurveyObject updateSurveyObject(SurveyObject surveyObject);
