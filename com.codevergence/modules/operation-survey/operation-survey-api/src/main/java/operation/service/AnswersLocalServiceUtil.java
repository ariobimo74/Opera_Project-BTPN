 ...
 * <code>operation.service.impl.AnswersLocalServiceImpl</code> and
...
public class AnswersLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>operation.service.impl.AnswersLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	...
	public static operation.model.Answers addAnswers(
		operation.model.Answers answers) {
	 ...
	 */
	public static operation.model.Answers createAnswers(long id) {
	 ...
	 */
	public static operation.model.Answers deleteAnswers(
		operation.model.Answers answers) {
	 ...
	 */
	public static operation.model.Answers deleteAnswers(long id)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	public static operation.model.Answers fetchAnswers(long id) {
	 ...
	 * @throws PortalException if a answers with the primary key could not be found
	 */
	public static operation.model.Answers getAnswers(long id)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	public static java.util.List<operation.model.Answers> getAnswerses(
		int start, int end) {
	 ...
	 */
	public static operation.model.Answers updateAnswers(
		operation.model.Answers answers) {

		return getService().updateAnswers(answers);
	}

	public static void validation(String answer, double value)
		throws com.liferay.portal.kernel.exception.PortalException {

		getService().validation(answer, value);
	}
