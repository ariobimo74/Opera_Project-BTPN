...
public class FooLocalServiceWrapper
	 ...
	 */
	@Override
	public operation.model.Foo addFoo(operation.model.Foo foo) {
	 ...
	 */
	@Override
	public operation.model.Foo createFoo(long fooId) {
	 ...
	 */
	@Override
	public operation.model.Foo deleteFoo(operation.model.Foo foo) {
	 ...
	 */
	@Override
	public operation.model.Foo deleteFoo(long fooId)
	...
	@Override
	public operation.model.Foo fetchFoo(long fooId) {
	 ...
	 */
	@Override
	public operation.model.Foo fetchFooByUuidAndGroupId(
	 ...
	 */
	@Override
	public operation.model.Foo getFoo(long fooId)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	@Override
	public operation.model.Foo getFooByUuidAndGroupId(String uuid, long groupId)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	@Override
	public java.util.List<operation.model.Foo> getFoos(int start, int end) {
	 ...
	 */
	@Override
	public java.util.List<operation.model.Foo> getFoosByUuidAndCompanyId(
	 ...
	 */
	@Override
	public operation.model.Foo updateFoo(operation.model.Foo foo) {
