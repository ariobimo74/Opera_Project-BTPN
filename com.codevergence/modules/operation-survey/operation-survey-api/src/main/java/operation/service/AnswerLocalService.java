...
public interface AnswerLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link AnswerLocalServiceUtil} to access the answer local service. Add custom service methods to <code>operation.service.impl.AnswerLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public Answer deleteAnswer(long id) throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Answer fetchAnswer(long id);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Answer getAnswer(long id) throws PortalException;
