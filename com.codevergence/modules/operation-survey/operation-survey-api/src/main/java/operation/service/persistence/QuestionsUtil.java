...
public class QuestionsUtil {
	 ...
	 */
	public static List<Questions> findByQuestion(String question) {
	 ...
	 */
	public static List<Questions> findByQuestion(
		String question, int start, int end) {

		return getPersistence().findByQuestion(question, start, end);
	}
	...
	public static List<Questions> findByQuestion(
		...
		return getPersistence().findByQuestion(
			question, start, end, orderByComparator, useFinderCache);
	}
	...
	public static List<Questions> findByQuestion(
		...
		return getPersistence().findByQuestion(
			question, start, end, orderByComparator);
	}
	 ...
	 */
	public static Questions findByQuestion_First(
			String question, OrderByComparator<Questions> orderByComparator)
		throws operation.exception.NoSuchQuestionsException {
	 ...
	 */
	public static Questions fetchByQuestion_First(
		String question, OrderByComparator<Questions> orderByComparator) {
	 ...
	 * @throws NoSuchQuestionsException if a matching questions could not be found
	 */
	public static Questions findByQuestion_Last(
			String question, OrderByComparator<Questions> orderByComparator)
		throws operation.exception.NoSuchQuestionsException {
	 ...
	 */
	public static Questions fetchByQuestion_Last(
		String question, OrderByComparator<Questions> orderByComparator) {
	 ...
	 */
	public static Questions[] findByQuestion_PrevAndNext(
			long id, String question,
			OrderByComparator<Questions> orderByComparator)
		throws operation.exception.NoSuchQuestionsException {

		return getPersistence().findByQuestion_PrevAndNext(
			id, question, orderByComparator);
	}
	 ...
	 * @param question the question
	 */
	public static void removeByQuestion(String question) {
		getPersistence().removeByQuestion(question);
	}
	 ...
	 */
	public static int countByQuestion(String question) {
