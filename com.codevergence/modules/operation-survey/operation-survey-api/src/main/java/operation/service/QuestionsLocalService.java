...
public interface QuestionsLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link QuestionsLocalServiceUtil} to access the questions local service. Add custom service methods to <code>operation.service.impl.QuestionsLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
