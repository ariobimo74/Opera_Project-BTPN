...
public class AnswersLocalServiceWrapper
	 ...
	 */
	@Override
	public operation.model.Answers addAnswers(operation.model.Answers answers) {
	...
	public operation.model.Answers addAnswers(
		...
		return _answersLocalService.addAnswers(answer, value, serviceContext);
	}
	 ...
	 */
	@Override
	public operation.model.Answers createAnswers(long id) {
		return _answersLocalService.createAnswers(id);
	}

	@Override
	public void deleteAllAnswers() {
		_answersLocalService.deleteAllAnswers();
	}
	 ...
	 */
	@Override
	public operation.model.Answers deleteAnswers(
	 ...
	 */
	@Override
	public operation.model.Answers deleteAnswers(long id)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	@Override
	public operation.model.Answers fetchAnswers(long id) {
	 ...
	 */
	@Override
	public operation.model.Answers getAnswers(long id)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	@Override
	public java.util.List<operation.model.Answers> getAnswerses(
		int start, int end) {
	 ...
	 */
	@Override
	public operation.model.Answers updateAnswers(
		operation.model.Answers answers) {
	...
	@Override
	public void validation(String answer, double value)
		throws com.liferay.portal.kernel.exception.PortalException {

		_answersLocalService.validation(answer, value);
	}
