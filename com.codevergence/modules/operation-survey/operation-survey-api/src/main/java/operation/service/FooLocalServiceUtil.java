 ...
 * <code>operation.service.impl.FooLocalServiceImpl</code> and
...
public class FooLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>operation.service.impl.FooLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static operation.model.Foo addFoo(operation.model.Foo foo) {
	 ...
	 * @return the new foo
	 */
	public static operation.model.Foo createFoo(long fooId) {
	 ...
	 */
	public static operation.model.Foo deleteFoo(operation.model.Foo foo) {
	 ...
	 */
	public static operation.model.Foo deleteFoo(long fooId)
	...
	public static operation.model.Foo fetchFoo(long fooId) {
	 ...
	 */
	public static operation.model.Foo fetchFooByUuidAndGroupId(
	 ...
	 * @throws PortalException if a foo with the primary key could not be found
	 */
	public static operation.model.Foo getFoo(long fooId)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	public static operation.model.Foo getFooByUuidAndGroupId(
			String uuid, long groupId)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	public static java.util.List<operation.model.Foo> getFoos(
		int start, int end) {
	 ...
	 */
	public static java.util.List<operation.model.Foo> getFoosByUuidAndCompanyId(
	...
	public static java.util.List<operation.model.Foo> getFoosByUuidAndCompanyId(
		...
		com.liferay.portal.kernel.util.OrderByComparator<operation.model.Foo>
			orderByComparator) {
	 ...
	 */
	public static operation.model.Foo updateFoo(operation.model.Foo foo) {
