...
public interface SampleLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link SampleLocalServiceUtil} to access the sample local service. Add custom service methods to <code>operation.service.impl.SampleLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
