...
public class QuestionsLocalServiceImpl extends QuestionsLocalServiceBaseImpl {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never reference this class directly. Use <code>operation.service.QuestionsLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>operation.service.QuestionsLocalServiceUtil</code>.
	 */
	...
	{
		return questionsPersistence.findByQuestion(question);
	}
}