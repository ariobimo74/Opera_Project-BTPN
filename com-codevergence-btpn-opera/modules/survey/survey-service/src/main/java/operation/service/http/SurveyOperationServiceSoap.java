...
public class SurveyOperationServiceSoap {
		...
		try {
			operation.model.SurveyOperation returnValue =
				SurveyOperationServiceUtil.addSurveyOperation(
					title, description, surveyObjId, startDate, endDate,
	...
	public static operation.model.SurveyOperationSoap updateSurveyOperation(
		...
		try {
			operation.model.SurveyOperation returnValue =
				SurveyOperationServiceUtil.updateSurveyOperation(
					id, title, description, surveyObjId, startDate, endDate,
					question1, question2, question3, question4, question5,
					question6, question7, question8, question9, question10,
					status, serviceContext);
