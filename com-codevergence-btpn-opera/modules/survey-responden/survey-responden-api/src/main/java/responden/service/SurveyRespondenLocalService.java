...
/**
 * Provides the local service interface for SurveyResponden. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see SurveyRespondenLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface SurveyRespondenLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link SurveyRespondenLocalServiceUtil} to access the survey responden local service. Add custom service methods to <code>responden.service.impl.SurveyRespondenLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	public SurveyResponden addSurveyResponden(SurveyResponden surveyResponden);
	...
	public SurveyResponden createSurveyResponden(long id);
	...
	public SurveyResponden deleteSurveyResponden(long id)
		throws PortalException;
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public SurveyResponden deleteSurveyResponden(
		SurveyResponden surveyResponden);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public SurveyResponden fetchSurveyResponden(long id);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public SurveyResponden getSurveyResponden(long id) throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<SurveyResponden> getSurveyRespondens(int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public SurveyResponden updateSurveyResponden(
		SurveyResponden surveyResponden);
