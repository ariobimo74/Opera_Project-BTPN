 ...
 * @generated
 */
public abstract class QuestionsFinderBaseImpl
	extends BasePersistenceImpl<Questions> {

	public QuestionsFinderBaseImpl() {
	...
	public Set<String> getBadColumnNames() {
		return questionsPersistence.getBadColumnNames();
	}
