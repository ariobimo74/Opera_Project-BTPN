...
import com.btpn.opera.operationsurvey.model.impl.SurveyOperationModelImpl;
 ...
 * @generated
 */
@Component(service = SurveyOperationPersistence.class)
@ProviderType
public class SurveyOperationPersistenceImpl
	...
	public SurveyOperationPersistenceImpl() {
		...
		dbColumnNames.put("surveyObjectId", "survey_object_id");
	...
	public void cacheResult(SurveyOperation surveyOperation) {
		entityCache.putResult(
			entityCacheEnabled, SurveyOperationImpl.class,
			surveyOperation.getPrimaryKey(), surveyOperation);
	...
	public SurveyOperation updateImpl(SurveyOperation surveyOperation) {
		...
		entityCache.putResult(
			entityCacheEnabled, SurveyOperationImpl.class,
			surveyOperation.getPrimaryKey(), surveyOperation, false);
	...
	public void activate() {
		SurveyOperationModelImpl.setEntityCacheEnabled(entityCacheEnabled);
		SurveyOperationModelImpl.setFinderCacheEnabled(finderCacheEnabled);
	...
	public void setConfiguration(Configuration configuration) {
		...
		_columnBitmaskEnabled = GetterUtil.getBoolean(
			configuration.get(
				"value.object.column.bitmask.enabled.com.btpn.opera.operationsurvey.model.SurveyOperation"),
			true);
	}
	...
	private static final Set<String> _badColumnNames = SetUtil.fromArray(
		new String[] {
			"surveyObjectId", "startDate", "endDate", "submittedDate",
