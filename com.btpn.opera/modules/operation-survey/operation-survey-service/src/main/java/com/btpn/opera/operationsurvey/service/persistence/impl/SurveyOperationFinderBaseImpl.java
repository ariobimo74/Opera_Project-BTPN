 ...
 * @generated
 */
public abstract class SurveyOperationFinderBaseImpl
	extends BasePersistenceImpl<SurveyOperation> {

	public SurveyOperationFinderBaseImpl() {
	...
	public Set<String> getBadColumnNames() {
		return surveyOperationPersistence.getBadColumnNames();
	}
	...
	private static final Log _log = LogFactoryUtil.getLog(
		SurveyOperationFinderBaseImpl.class);
