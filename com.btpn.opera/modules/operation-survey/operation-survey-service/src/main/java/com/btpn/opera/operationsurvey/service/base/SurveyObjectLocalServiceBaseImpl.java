...
import com.btpn.opera.operationsurvey.service.SurveyObjectLocalService;
...
/**
 * Provides the base implementation for the survey object local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.btpn.opera.operationsurvey.service.impl.SurveyObjectLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.btpn.opera.operationsurvey.service.impl.SurveyObjectLocalServiceImpl
 * @generated
 */
@ProviderType
public abstract class SurveyObjectLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements SurveyObjectLocalService, AopService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SurveyObjectLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.btpn.opera.operationsurvey.service.SurveyObjectLocalServiceUtil</code>.
	 */
	...
	public SurveyObject addSurveyObject(SurveyObject surveyObject) {
		...
		return surveyObjectPersistence.update(surveyObject);
	}
	...
	public SurveyObject createSurveyObject(long id) {
		return surveyObjectPersistence.create(id);
	}
	...
	public SurveyObject deleteSurveyObject(long id) throws PortalException {
		return surveyObjectPersistence.remove(id);
	}
	...
	public SurveyObject deleteSurveyObject(SurveyObject surveyObject) {
		return surveyObjectPersistence.remove(surveyObject);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			SurveyObject.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return surveyObjectPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return surveyObjectPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return surveyObjectPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return surveyObjectPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public SurveyObject fetchSurveyObject(long id) {
		return surveyObjectPersistence.fetchByPrimaryKey(id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(surveyObjectLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(SurveyObject.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(SurveyObject.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return surveyObjectLocalService.deleteSurveyObject(
			(SurveyObject)persistedModel);
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return surveyObjectPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<SurveyObject> getSurveyObjects(int start, int end) {
		return surveyObjectPersistence.findAll(start, end);
	}
	...
	public int getSurveyObjectsCount() {
		return surveyObjectPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			SurveyObjectLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		surveyObjectLocalService = (SurveyObjectLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return SurveyObjectLocalService.class.getName();
	}
	...
	protected SurveyObjectLocalService surveyObjectLocalService;
