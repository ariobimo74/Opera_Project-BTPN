...
import com.btpn.opera.operationsurvey.service.QuestionsLocalService;
...
/**
 * Provides the base implementation for the questions local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.btpn.opera.operationsurvey.service.impl.QuestionsLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.btpn.opera.operationsurvey.service.impl.QuestionsLocalServiceImpl
 * @generated
 */
@ProviderType
public abstract class QuestionsLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements QuestionsLocalService, AopService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>QuestionsLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.btpn.opera.operationsurvey.service.QuestionsLocalServiceUtil</code>.
	 */
	...
	public Questions createQuestions(long id) {
		return questionsPersistence.create(id);
	}
	...
	public Questions deleteQuestions(Questions questions) {
		return questionsPersistence.remove(questions);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			Questions.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return questionsPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return questionsPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return questionsPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return questionsPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public Questions fetchQuestions(long id) {
		return questionsPersistence.fetchByPrimaryKey(id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(questionsLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(Questions.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(Questions.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return questionsLocalService.deleteQuestions((Questions)persistedModel);
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return questionsPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<Questions> getQuestionses(int start, int end) {
		return questionsPersistence.findAll(start, end);
	}
	...
	public int getQuestionsesCount() {
		return questionsPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			QuestionsLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		questionsLocalService = (QuestionsLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return QuestionsLocalService.class.getName();
	}
