...
import com.btpn.opera.operationsurvey.service.SurveyOperationViewService;
...
/**
 * Provides the base implementation for the survey operation view remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.btpn.opera.operationsurvey.service.impl.SurveyOperationViewServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.btpn.opera.operationsurvey.service.impl.SurveyOperationViewServiceImpl
 * @generated
 */
public abstract class SurveyOperationViewServiceBaseImpl
	extends BaseServiceImpl
	implements SurveyOperationViewService, AopService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SurveyOperationViewService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.btpn.opera.operationsurvey.service.SurveyOperationViewServiceUtil</code>.
	 */
	@Override
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			SurveyOperationViewService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		surveyOperationViewService = (SurveyOperationViewService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return SurveyOperationViewService.class.getName();
	}
	...
	@Reference
	protected
		com.btpn.opera.operationsurvey.service.SurveyOperationViewLocalService
			surveyOperationViewLocalService;

	protected SurveyOperationViewService surveyOperationViewService;
