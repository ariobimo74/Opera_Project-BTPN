...
import com.btpn.opera.operationsurvey.service.SurveyOperationViewLocalService;
...
/**
 * Provides the base implementation for the survey operation view local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.btpn.opera.operationsurvey.service.impl.SurveyOperationViewLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.btpn.opera.operationsurvey.service.impl.SurveyOperationViewLocalServiceImpl
 * @generated
 */
@ProviderType
public abstract class SurveyOperationViewLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements SurveyOperationViewLocalService, AopService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SurveyOperationViewLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.btpn.opera.operationsurvey.service.SurveyOperationViewLocalServiceUtil</code>.
	 */
	...
	public SurveyOperationView addSurveyOperationView(
		...
		return surveyOperationViewPersistence.update(surveyOperationView);
	}
	...
	public SurveyOperationView createSurveyOperationView(long id) {
		return surveyOperationViewPersistence.create(id);
	}
	...
	public SurveyOperationView deleteSurveyOperationView(long id)
		...
		return surveyOperationViewPersistence.remove(id);
	}
	...
	public SurveyOperationView deleteSurveyOperationView(
		...
		return surveyOperationViewPersistence.remove(surveyOperationView);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			SurveyOperationView.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return surveyOperationViewPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return surveyOperationViewPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	public SurveyOperationView fetchSurveyOperationView(long id) {
		return surveyOperationViewPersistence.fetchByPrimaryKey(id);
	}
	...
	public SurveyOperationView getSurveyOperationView(long id)
		...
		return surveyOperationViewPersistence.findByPrimaryKey(id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(SurveyOperationView.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return surveyOperationViewLocalService.deleteSurveyOperationView(
			(SurveyOperationView)persistedModel);
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return surveyOperationViewPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<SurveyOperationView> getSurveyOperationViews(
		...
		return surveyOperationViewPersistence.findAll(start, end);
	}
	...
	public int getSurveyOperationViewsCount() {
		return surveyOperationViewPersistence.countAll();
	}
	...
	public void setAopProxy(Object aopProxy) {
		surveyOperationViewLocalService =
			(SurveyOperationViewLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return SurveyOperationViewLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				surveyOperationViewPersistence.getDataSource();
	...
	protected SurveyOperationViewLocalService surveyOperationViewLocalService;
