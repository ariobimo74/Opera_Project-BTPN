...
public class SurveyOperationUtil {
	...
	public static SurveyOperation findByTitle_First(
		...
		throws com.btpn.opera.operationsurvey.exception.
			NoSuchSurveyOperationException {
