...
/**
 * Provides the local service interface for Responden. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see RespondenLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface RespondenLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link RespondenLocalServiceUtil} to access the responden local service. Add custom service methods to <code>com.btpn.opera.operationsurvey.service.impl.RespondenLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
