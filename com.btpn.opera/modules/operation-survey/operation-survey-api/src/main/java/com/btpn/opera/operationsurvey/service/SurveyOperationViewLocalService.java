...
/**
 * Provides the local service interface for SurveyOperationView. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see SurveyOperationViewLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface SurveyOperationViewLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link SurveyOperationViewLocalServiceUtil} to access the survey operation view local service. Add custom service methods to <code>com.btpn.opera.operationsurvey.service.impl.SurveyOperationViewLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	public SurveyOperationView addSurveyOperationView(
	...
	public SurveyOperationView createSurveyOperationView(long id);
	...
	public SurveyOperationView deleteSurveyOperationView(long id)
		throws PortalException;
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public SurveyOperationView deleteSurveyOperationView(
		SurveyOperationView surveyOperationView);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public SurveyOperationView fetchSurveyOperationView(long id);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public SurveyOperationView getSurveyOperationView(long id)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<SurveyOperationView> getSurveyOperationViews(
		int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public SurveyOperationView updateSurveyOperationView(
		SurveyOperationView surveyOperationView);
