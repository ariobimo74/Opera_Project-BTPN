...
/**
 * Provides the local service interface for SurveyOperationUsersView. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see SurveyOperationUsersViewLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface SurveyOperationUsersViewLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link SurveyOperationUsersViewLocalServiceUtil} to access the survey operation users view local service. Add custom service methods to <code>com.btpn.opera.operationsurvey.service.impl.SurveyOperationUsersViewLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
