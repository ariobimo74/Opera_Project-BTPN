...
/**
 * This class is used by SOAP remote services, specifically {@link com.btpn.opera.operationsurvey.service.http.AnswersServiceSoap}.
 *
...
public class AnswersSoap implements Serializable {
	...
	public static AnswersSoap toSoapModel(Answers model) {
		...
		soapModel.setQuestionsId(model.getQuestionsId());
